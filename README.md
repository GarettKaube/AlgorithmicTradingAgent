...
<img src="./images/feature_importance.png" alt="My Image" width="800">
As we can see, the model found the features generated by the HMM important compared to others in sample.

#### Performance Over Time:
<table>
  <tr>
    <td><img src="./images/roc_ot.png" alt="Image 1" width="500"></td>
    <td><img src="./images/logloss_overtime.png" alt="Image 2" width="500"></td>
  </tr>
</table>
